...
class BookManager:
    ...
    def start (self, book_selection_prompt):
        ...
        while True:
            ...
            # # for testing start
            # print(f'Supported books: ', supported_books)
            # print(book_selection_prompt)
            # customer_input = 'note'
            # # customer_input = 'contact'
            # # for testing end
        ...
        def run_operation_from_customer_input (user_operation_input: str = ''):
            while True:
                if user_operation_input == '':
                    ...
                    # print(book_operation_selection_prompt)
                    # user_operation_input = 'update-note'
                    # user_operation_input = 'add-note'
                    # # user_operation_input = 'update-contacts'
                    # # used for testing purposes end

                if user_operation_input in supported_operations_keys:
                    # used for testing purposes start
                    print(f'{book_name} operation {book_operation_selection_prompt} is currently processing.')
                    # used for testing purposes end
    ...
    def handle_command_execution_duplicate_result (self, book, result_records, conditions):

        print(conditions)
        print(f'Record UPDATED')

    def handle_book_operation (self, book_name):
        exit('lololo byebye, no handle yet!')
